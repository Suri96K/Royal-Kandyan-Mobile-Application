...
public class LeaveReqCheckActiivity extends AppCompatActivity {
    ...
    String HttpURL = "http://localhost/CheckLeaveReq.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leave_req_check_actiivity);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new GetDataFromServerIntoTextView(LeaveReqCheckActiivity.this).execute();
