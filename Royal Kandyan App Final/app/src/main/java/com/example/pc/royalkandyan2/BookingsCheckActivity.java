...
public class BookingsCheckActivity extends AppCompatActivity {
    ...
    String HttpURL = "http://localhost/CheckBookings.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bookings_check);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new GetDataFromServerIntoTextView(BookingsCheckActivity.this).execute();
