...
public class NotificationsForPos extends AppCompatActivity {
    ...
    String HttpURL = "http://localhost/NotificationsForPos.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_notifications_for_pos);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new GetDataFromServerIntoTextView(NotificationsForPos.this).execute();
