...
public class LaundrycheckActivity extends AppCompatActivity {
    ...
    String HttpURL = "http://localhost/checklaundry.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_laundrycheck);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new GetDataFromServerIntoTextView(LaundrycheckActivity.this).execute();
