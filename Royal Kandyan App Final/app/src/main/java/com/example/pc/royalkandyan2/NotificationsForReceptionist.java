...
public class NotificationsForReceptionist extends AppCompatActivity {
    ...
    String HttpURL = "http://localhost/NotificationsForReceptionist.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_notifications_for_receptionist);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new GetDataFromServerIntoTextView(NotificationsForReceptionist.this).execute();
