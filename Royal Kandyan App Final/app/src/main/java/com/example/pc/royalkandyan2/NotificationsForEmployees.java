...
public class NotificationsForEmployees extends AppCompatActivity {
    ...
    String HttpURL = "http://localhost/NotificationsForEmployees.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_notifications_for_employees);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new GetDataFromServerIntoTextView(NotificationsForEmployees.this).execute();
