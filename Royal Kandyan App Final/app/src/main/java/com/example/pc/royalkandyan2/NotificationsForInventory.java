...
public class NotificationsForInventory extends AppCompatActivity {
    ...
    String HttpURL = "http://localhost/NotificationsForInventory.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_notifications_for_inventory);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new GetDataFromServerIntoTextView(NotificationsForInventory.this).execute();
