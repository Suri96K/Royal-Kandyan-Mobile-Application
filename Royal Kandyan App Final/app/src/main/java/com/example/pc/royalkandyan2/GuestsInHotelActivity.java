...
public class GuestsInHotelActivity extends AppCompatActivity {
    ...
    String HttpURL = "http://localhost/CheckGuestsInHotel.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_guests_in_hotel);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new GetDataFromServerIntoTextView(GuestsInHotelActivity.this).execute();
