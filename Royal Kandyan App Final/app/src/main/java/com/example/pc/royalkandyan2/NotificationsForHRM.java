...
public class NotificationsForHRM extends AppCompatActivity {
    ...
    String HttpURL = "http://localhost/NotificationsForHRM.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_notifications_for_hrm);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new GetDataFromServerIntoTextView(NotificationsForHRM.this).execute();
