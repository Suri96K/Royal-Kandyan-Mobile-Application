...
public class NotificationsForHouseKeeping extends AppCompatActivity {
    ...
    String HttpURL = "http://localhost/NotificationsForHouseKeeping.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_notifications_for_house_keeping);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new GetDataFromServerIntoTextView(NotificationsForHouseKeeping.this).execute();
